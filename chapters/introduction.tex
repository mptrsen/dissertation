...
insects, I present in chapter \ref{cha:dynamics} an extended analysis on
the genomes of 96 arthropod species and genome size estimate data from
613 arthropod species. The study infers a comprehensive, time-calibrated
...
genome. The rates of TE-associated DNA gain and loss are correlated with
the phylogeny. It is also shown that TE copies can no longer be
recognized after about 100 Mya. The chapter discusses a trend towards
genome size stability despite varying rates of DNA removal in insects.
