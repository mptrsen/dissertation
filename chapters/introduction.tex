...
genome sequences in the NCBI database \citep{O'Leary2016} (about 0.3 \%
of the total non-insect species diversity; Figure
\ref{fig:biodiversity}) and 493 insect genomes (0.065 \%; about five
...
to even sequence 10 \% of the insect biodiversity. During this time,
many species will have gone extinct --- as it stands, our sequencing
efforts are losing the race against man-made biodiversity loss.
Ever-improving, massively parallel sequencing technologies that appeared
during the early 2000's \citep{Behjati2013} have accelerated the pace
and accuracy at which genomes can be sequenced, but it will not be
enough. Of many insect species, we will never be able to obtain the
genomic source code.
