...
excised, silenced and removed at a likewise constant rate. Thus,
insertion rate and removal/silencing rate cancel each other out, and the
genome size remains stable.
