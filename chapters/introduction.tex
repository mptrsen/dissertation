...
that share BRH relations, one can form clusters of orthologous genes
(COGs), or simply orthologous groups (OGs) \citep{Altenhoff2012}.  This
approach has been implemented in several software packages for use
in genomic datasets (\eg, \citep{Li2003, Tatusov2003, Berglund2008,
Zdobnov2017}). Obtaining a complete genome sequence is, however,
...
and may therefore be missing from the sequenced RNA. While this is
...
The software, Orthograph, has been used in several co-authored studies
\citep{Mayer2016, Pauli2016, Bank2017, Dowling2017, Peters2017,
Gillung2018, Johnson2018} that are in the appendix
\ref{papers-using-orthograph}.
