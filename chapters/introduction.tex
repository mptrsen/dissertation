...
\section{The genomes of insects}
...
such as genes and transposable elements. However, genome architecture
and structural dynamics in insects appear drastically different from
...
shows that the TE copy age distribution is highly diverse and that some
TEs are recently active among insects.
