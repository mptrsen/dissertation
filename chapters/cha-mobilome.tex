...
\caption{{TE content in 73 arthropod genomes is positively correlated to genome
...
\caption{{~The Alu element found in~\emph{Bombyx mori}: Alignment of the canonical
