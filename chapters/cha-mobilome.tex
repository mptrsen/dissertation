...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.6\textwidth]{te-coverage-vs-genome-size}
...
\subsection{TE content contributes to genome size in arthropods}
...
\citep{Neafsey2015} and \emph{Drosophila} fruit flies
...
\subsection{TE landscape diversity in arthropods}
