...
\species{Tetraodon nigroviridis} to more than 55 \% in the zebrafish
\species{Danio rerio} \citep{Chalopin2015}. More than 45 \% of the human
genome \citep{deKoning2011} consist of TEs. In plants, TEs are even more
prevalent: up to 90 \% of the maize (\species{Zea mays}) genome is
covered by TEs \citep{SanMiguel1996}. In insects, the genomic portion of
TEs ranges from as little as 1 \% in the antarctic midge
\citep{Kelley2014} to as large as 65 \% in the migratory locust
\citep{Wang2014}.
...
\citep{Mackay1989}. Due to their propagation in the genome, TEs are
...
fruit fly \species{Drosophila melanogaster}, which consists mostly of
TEs, is thought to be caused by such intrachromosomal rearrangements
induced by ectopic recombination \citep{Adams2000}. As such potent
agents for mutation, TEs are also responsible for cancer and genetic
diseases in humans and other organisms
...
\species{Arabidopsis thaliana} \citep{Marin2000}, Ty1/Copia
...
mosquito \species{Aedes aegypti} to less than 1 \% in \species{B.
antarctica}. Even among closely related \species{Drosophila} species,
the TE content ranges from 40 \% (in \species{D. ananassae}) to 10 \%
(in \species{D. miranda} and \species{D.  simulans}). The highest TE
content (60 \%) was found in the large genome (6.5 Gbp) of the migratory
locust \species{Locusta migratoria} (Orthoptera), while the smallest
known insect genome, that of the antarctic midge \species{Belgica
antarctica} (Diptera, 99 Mbp), was found to contain less than 1 \% TEs.
...
TE coverage in the mayfly \species{Ephemera danica} or the copepod
\species{Eurytemora affinis}.  However, in most investigated
\species{Drosophila} species the unclassifiable elements comprise less
than 25 \% and in \species{D.  simulans} only 11 \% of the entire TE
...
in some cases contributing around 50 \% (e.g., in \species{D.
simulans}). In Hymenoptera, on the other hand, DNA transposons are more
prevalent, such as in Jerdon's jumping ant \species{Harpegnathos
saltator}. LINE retrotransposons are most prominent in Hemiptera and
Psocodea, with the exception of the human body louse \species{Pediculus
humanus}, whose DNA transposons contribute the major part of the known
...
except the Asian long horned beetle, \species{Anoplophora glabripennis},
...
\species{Bombyx mori} (Figure \ref{fig:alu}, all Alu alignments are
...
\caption[The Alu element found in \species{Bombyx mori}]{{The Alu element
found in \species{Bombyx mori}: Alignment of the canonical Alu sequence
from Repbase with HMM hits in the~\species{B. mori} genome assembly. Grey
...
superfamilies, with the locust \species{L. migratoria} exhibiting the
greatest diversity (61 different TE superfamilies), followed by the tick
\species{Ixodes scapularis} (60), the velvet worm
\species{Euperipatoides rowelli} (59), and the dragonfly \species{Ladona
fulva} (59). Overall, Chelicerata have the highest average TE
...
respectively). The lowest diversity was found in \species{A. aegypti},
...
Proto2 was found in all Hymenoptera except in the ant \species{H.
saltator}. Similarly, the DNA element Harbinger was found in all
Lepidoptera except for the silkworm \species{B. mori}. Also within
Palaeoptera (\emph{i.e.}, mayflies, damselflies, and dragonflies), the
DNA element Harbinger is absent in \species{E. danica}, but present in
...
\species{Copidosoma floridanum}, but not in other Hymenoptera, and the
DNA element Novosib was found only in \species{B. mori}, but not in
other Lepidoptera. Within Coleoptera, only the Colorado potato beetle,
\species{Leptinotarsa decemlineata} harbors the LINE Odin. Likewise, we
found the LINE Odin among Lepidoptera only in the noctuid
\species{Helicoverpa punctigera}. These examples of clade or lineage
...
only absent in \species{D. miranda}, but bi-modal in \species{D.
...
breakpoints on the third chromosome of \species{D. pseudoobscura}, which
...
calyptrate flies \species{Musca domestica}, \species{Ceratitis
capitata}, and \species{Lucilia cuprina}, but absent in all acalyptrate
flies, including representatives of the \species{Drosophila} family.
...
representing 28 \% of the genome in the house fly \species{M. domestica}
and 7 \% in the blow fly \species{Lucilia cuprina}. These rolling circle
elements are not as abundant in acalyptrate flies, except for the
drosophilids \species{D. mojavensis}, \species{D. virilis}, \species{D.
miranda}, and \species{D. pseudoobscura} (again with a bi-modal
distribution). In the barley midge, \species{Mayetiola destructor}, DNA
...
show little occurrence in Diptera. In \species{B. antarctica}, LINE
...
concentration in the small \species{B. antarctica} genome (less than 1
...
up to 9 \% in the silk worm \species{B. mori} (mean: 3.8 \%). We
observed that in the postman butterfly, \species{Heliconius melpomene},
...
in the monarch butterfly \species{Danaus plexippus} with a divergence
...
\species{Onthophagus taurus}, \species{Agrilus planipennis}, and
\species{L.  decemlineata}, this fraction consists mostly of LINE
copies, while in \species{T. castaneum} and \species{A. glabripennis}
...
\ref{fig:te-coverage}). Interestingly, \species{Mengenilla moldrzyki}, a
...
\species{Camponotus floridanus}, which shows no such distinct peak.
Instead, in \species{C. floridanus}, we found DNA elements and LTR
elements with a relatively homogeneous coverage distribution between
Kimura distances 0.03 and 0.4. \species{C. floridanus} is also the only
...
genome of the honey bee, \species{Apis mellifera} contains a large
fraction of Helitron elements with a Kimura distance between 0.1 and
0.35, as does \species{Nasonia vitripennis} with peak coverage around
...
parasitic wood wasp, \species{O. abietinus}, the divergence distribution
is similar to that in ants, with a dominant DNA transposon coverage
around Kimura distance 0.05. The turnip sawfly, \species{A. rosae} has a
...
psocodean \species{P. humanus} apart from Hemiptera and Thysanoptera.
Additionally, the human body louse, \species{P. humanus} exhibits a
...
around Kimura distance 0.05 instead of around 0.3, like in \species{P.
humanus}, or only in miniscule amounts, such as in \species{Halyomorpha
halys}.  Interestingly, the three bug species \species{H. halys},
\species{Oncopeltus fasciatus}, and \species{Cimex lectularius} show a
...
\species{Gerris buenoi} and the flower thrips \species{Frankliniella
occidentalis} as well as the cicadellid \species{Homalodisca
vitripennis}, the Helitron elements show a distinct coverage between
Kimura distances 0 and 0.3, with peak coverage at around 0.05 to 0.1
(\species{F. occidentalis}, \species{G. buenoi}) resp.  0.2 (\species{H.
vitripennis}). In both \species{F. occidentalis} and \species{G.
buenoi}, the divergence distribution is slightly bi-modal. In
\species{H.  vitripennis}, LINEs and DNA elements exhibit a divergence
...
stark contrast to the findings in the pea aphid \species{Acyrthosiphon
pisum}, where SINEs make up the majority of the TE content and exhibit a
...
elements are distinctly absent from the \species{A. pisum} genome,
...
cockroach \species{Blattella germanica} have a peak coverage at around
Kimura distance 0.04. In the termite \species{Zootermopsis nevadensis},
the peak LINE coverage is between Kimura distances 0.2 and 0.4. In the
locust \species{L. migratoria}, LINE coverage shows a broad divergence
...
LINEs also dominate the TE landscape in Paleoptera. The mayfly
\species{E.  danica} additionally exhibits a population of LTR elements
with medium divergence in the genome. In the dragonfly \species{L.
fulva}, we found DNA elements of similar coverage and divergence as the
LTR elements. Both TE types have almost no low-divergence elements in
\species{L. fulva}. In the early divergent apterygote hexapod orders
Diplura (represented by the species \species{Catajapyx aquilonaris}) and
Archaeognatha (\species{Machilis hrabei}), DNA elements are abundant
...
divergence regions in the genome of \species{C.  aquilonaris} as well as
SINE peak coverage at slightly higher divergence in \species{M. hrabei}.
...
the spider \species{Parasteatoda tepidariorum} and the tick \species{I.
scapularis}. The only available myriapod genome, that of the centipede
\species{Strigamia maritima}, is dominated by LTR elements with high
...
\species{Daphnia pulex}, but the TE divergence distribution in the other
crustacean species was different and consisted of more DNA transposons
in the copepod \species{E. affinis}, or LINEs in the amphipod
...
shown in \species{D. melanogaster} to exhibit a high density of TEs
...
of \species{Drosophila} spp. \citep{Perrat2013,Li2013,Blumenstiel2013}
or in the genome of the British peppered moth \species{Biston
betularia}, in which a tandemly repeated TE confers an adaptive
...
\species{Aedes} and \species{Anopheles} mosquito genomes.
...
her help with inbreeding of and DNA extraction from \species{G. buenoi}.
We are grateful to Dorith Rotenberg for coordinating the \species{F.
...
acknowledge the coordinators of the i5k \species{Blattella} genome
...
\species{H. halys} available for analysis. Finally, we thank John
