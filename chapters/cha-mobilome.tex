...
varies from around 55 \% in the yellow fever mosquito \species{Aedes
aegypti} to less than 1 \% in \species{B. antarctica}. Even among
closely related \species{Drosophila} species, the TE content ranges from
40 \% (in \species{D. ananassae}) to 10 \% (in \species{D. miranda} and
\species{D.  simulans}). The highest TE content (60 \%) was found in the
large genome (6.5 Gbp) of the migratory locust \species{Locusta
migratoria} (Orthoptera), while the smallest known insect genome, that
of the antarctic midge \species{Belgica antarctica} (Diptera, 99 Mbp),
...
\species{Ephemera danica} or the copepod \species{Eurytemora affinis}.
However, in most investigated \species{Drosophila} species the
unclassifiable elements comprise less than 25 \% and in \species{D.
...
(e.g., in \species{D. simulans}). In Hymenoptera, on the other hand, DNA
transposons are more prevalent, such as in Jerdon's jumping ant
\species{Harpegnathos saltator}. LINE retrotransposons are most
prominent in Hemiptera and Psocodea, with the exception of the human
body louse \species{Pediculus humanus}, whose DNA transposons contribute
...
long horned beetle, \species{Anoplophora glabripennis}, and the B4
...
genomes, for example in the silkworm \species{Bombyx mori} (Fig. 4, all
...
\species{D. miranda}, but bi-modal in \species{D. pseudoobscura}, with a
...
chromosome of \species{D. pseudoobscura}, which are only a million years
...
\species{Musca domestica}, \species{Ceratitis capitata}, and
\species{Lucilia cuprina}, but absent in all acalyptrate flies,
including representatives of the \species{Drosophila} family. Likely,
...
\species{Mengenilla moldrzyki}, a representative of Strepsiptera, which
...
been shown in \species{D. melanogaster} to exhibit a high density of TEs
