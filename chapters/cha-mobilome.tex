...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=500]{figures/te-coverage-in-insect-genomes/te-coverage-in-insect-genomes-both}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.70\columnwidth]{figures/te-coverage-vs-genome-size/te-coverage-vs-genome-size}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=500]{figures/presence-absence-reduced-with-tree1/presence-absence-reduced-with-tree}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1.00\columnwidth]{figures/Alu-in-Zootermopsis-nevadensis/Alu-in-Zootermopsis-nevadensis}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=500]{figures/tree-with-landscapes3/tree-with-landscapes-and-larger-plots}
