...
\ifdraft{%
	...
	\section{Misof et al. (2014): Phylogenomics resolves the timing and pattern of insect evolution}\label{app:Misof2014}
	\emptypages{5} % Misof2014
	\section{Dell'Ampio et al. (2014): Decisive data sets in phylogenomics: lessons from studies on the phylogenetic relationships of primarily wingless insects}
...
\includepdf[addtotoc={1,section,1,Dell'Ampio et al. (2014): Decisive data sets in phylogenomics: lessons from studies on the phylogenetic relationships of primarily wingless insects,app:DellAmpio2014},pages=-]{appendix/B/DellAmpio2014} % range without endpoints: from first to last
